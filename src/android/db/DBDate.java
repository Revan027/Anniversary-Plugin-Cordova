package com.uniclau.alarmplugin.db;
...
public class DBDate extends SQLiteOpenHelper {
	...
	public static final String COLUMN_DATE_RAPPEL = "heure";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("create table " +TABLE_NAME+"(id integer primary key AUTOINCREMENT, date text, 'date_rappel' VARCHAR(400) NOT NULL DEFAULT)");
	}
